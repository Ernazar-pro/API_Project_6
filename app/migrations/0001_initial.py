# Generated by Django 4.2.6 on 2023-10-07 16:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('members', models.ManyToManyField(related_name='project_2', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=256)),
                ('description', models.TextField(blank=True, null=True)),
                ('deadline_date', models.DateField(auto_now=True, null=True)),
